...
class Page{
    constructor(){
        ...
        this.tops_checkboxs = Selector('#layered_category_4');
        this.dresses_checkboxs = Selector('#layered_category_9');
        this.tshirt_checkboxs = Selector('#layered_id_attribute_group_1');
        this.price_slider = Selector('.ui-slider-handle');
        this.loading_gif = Selector('#center_column > ul > p > img');
